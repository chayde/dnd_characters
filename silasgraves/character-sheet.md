...
| Ability | Base | Racial | Total | Modifier | Saving Throw |
|---------|------|--------|-------|----------|--------------|
| STR     | 8    | -      | 8     | -1       | -1           |
| DEX     | 14   | -      | 14    | +2       | +2           |
| CON     | 14   | -      | 14    | +2       | +2           |
...
### Racial Traits (Rock Gnome - 2024 rules)
- **Darkvision:** 60 feet
- **Gnome Cunning:** Advantage on all INT, WIS, and CHA saving throws against magic
- **Artificer's Lore:** Add double proficiency bonus to History checks related to magic items, alchemical objects, or technological devices
- **Gnome Cantrips (2024):** Mending and Prestidigitation
...
**Researcher:** When you attempt to learn or recall a piece of lore, if you don't know that information, you often know where and from whom you can obtain it. Usually from a library, scriptorium, university, sage, or other learned person or creature.
...
### Carried Equipment
- *The Final Ledger* (spellbook & mortuary records)
- Component pouch
- Arcane focus (bone-carved amulet)
- Undertaker's tools
...
- 4 from Wizard class (Mage Hand, Message, Mind Sliver, Minor Illusion)
- 2 from Magic Initiate (Chill Touch, Toll the Dead)
...
### Animated Undead: Rose and Thorn Durst (Skeletons)
