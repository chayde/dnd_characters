...
## Level 7: Battle Master Enhancement
**New Features:**
...
## Level 9: Indomitable Resolve
**New Features:**
- **Indomitable (1/Long Rest):** When you fail a saving throw, you can reroll it with a bonus equal to your **Fighter Level (+9)**.
- **Tactical Master:** You can now use the **Push, Sap, or Slow** mastery even if the weapon doesn't have it (replacing the weapon's normal property).
- **Strategy:** If you need to keep an enemy away from Anika but don't want to knock them prone, you can swap your Maul's **Topple** for **Push** (knocking them 10ft away).

---

## Level 10: Improved Combat Superiority
**New Features:**
- **Superiority Dice Upgrade:** Your dice turn from **d8s into d10s**.
- **New Maneuvers:** You learn **2 more maneuvers** (Total: 7).
- **Recommendation:** 
    1. **Tactical Shift:** Move half your speed without provoking opportunity attacks when you use a maneuver.
    2. **Goading Attack:** If you hit a creature, it has disadvantage on attacks against anyone *other than you* (another way to force them to ignore Anika).

---

## Level 11: Extra Attack (2)
**New Features:**
- **Three Attacks:** You now make **three attacks** per Action (6 with Action Surge).
- **Impact:** This drastically increases your chances of triggering **Topple** or **Crusher** on your turn, ensuring enemies are locked down for Anika.
...
- **CHA:** 5
- **Proficiency Bonus:** +4
- **AC:** 19+ (Plate + Defense + Potential Magic Armor)
- **Superiority Dice:** 5d10 per Short Rest
