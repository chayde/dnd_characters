# Character Sheet — Bwayne

## Basic Information
**Name:** Bwayne  
**Class:** Paladin (Oath of Vengeance)  
**Level:** 9  
**Background:** The Vanished (Criminal/Enforcer)  
**Race:** Dragonborn (Black Scales - 2024 Rules)  
**Alignment:** Lawful Neutral  
**Faith:** Hoar, the Doombringer  

**Spellcasting Ability:** Charisma  
**Divine Mount:** Junior (Find Steed)  
...
| :--- | :--- | :--- | :--- |
| **STR** | 25 | **+7** | **+13** (Prof + Aura) |
| **DEX** | 10 | +0 | **+2** (Aura) |
| **CON** | 14 | +2 | **+8** (Prof + Aura) |
| **INT** | 9 | -1 | **+1** (Aura) |
| **WIS** | 14 | +2 | **+8** (Prof + Aura) |
| **CHA** | 14 | +2 | **+8** (Prof + Aura) |

*Note: Strength is set to 25 by the **Belt of Fire Giant Strength**. Aura of Protection (+2) is included in Saving Throws.*

---

## Combat Statistics
**Armor Class:** 19 (Plate Armor +1)  
**Initiative:** +0 (Advantage from Halberd of Warning)  
**Speed:** 30 ft. (Walking) / 30 ft. (Flying via Winged Boots)  
**Hit Points:** 76  
**Hit Dice:** 9d10  
**Proficiency Bonus:** +4  
...
## Equipment
*   **Lightning Halberd +2:** +2 bonus to attack/damage; +2d6 lightning damage on hit.
*   **Halberd of Warning +1:** Advantage on Initiative; you and allies within 30ft can't be surprised.
*   **Plate Armor +1:** AC 19.
*   **Belt of Fire Giant Strength:** STR 25.
*   **Winged Boots:** Flying speed equal to walking speed (4 hours total/day).
*   **Bag of Holding:** Carries up to 500 lbs.
...
### Prepared Spells
*   **1st:** Bless, Shield of Faith, Wrathful Smite, Compelled Duel, Bane (Oath), Hunter's Mark (Oath).
*   **2nd:** Hold Person, Lesser Restoration, Misty Step (Oath), Zone of Truth.
*   **3rd:** Revivify, Dispel Magic, Haste (Oath), Protection from Energy (Oath).
*   **Special:** Find Steed (Always active - Junior).
